    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl max-w-md w-full p-6 relative">
        ...
        <div className="text-center mb-6">
          ...
          <h2 className="text-xl font-bold text-slate-800 dark:text-white">Unlock Premium</h2>
          <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">Get full access to all features</p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <button className="flex flex-col items-center p-3 bg-[#1A73E8] rounded-xl hover:bg-[#1557B0] transition-colors relative">
            ...
            <span className="text-xs text-white/80">per year</span>
          </button>
        </div>

        <p className="text-center text-xs text-slate-400 mt-4">Cancel anytime. No hidden fees.</p>
      </div>
    </div>
  )
}
